...
def render_html(html: str):
    """st.markdown renders 4+ space indented lines as a code block, which turns
    raw HTML tags into visible plain text. Strip leading whitespace on every
    line (safe for HTML/SVG, since it isn't whitespace-sensitive) before handing
    it to st.markdown, regardless of how deeply the source code is nested."""
